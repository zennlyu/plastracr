...
//  PageController get controller => this.createState()._controller;
  ...
  ///[IndicatorType]
  final IndicatorType? indicatorTypes;
...
class _IntroScreensState extends State<IntroScreens> with TickerProviderStateMixin {
  ...
  Widget get next => this.widget.nextWidget ?? Icon(
    Icons.arrow_forward,
    size: 28,
    color: widget.textColor,
  );

  Widget get done => this.widget.doneWidget ?? Icon(
    Icons.check,
    size: 28,
    color: widget.textColor,
  );
  ...
  LinearGradient get gradients => existGradientColors ? LinearGradient(
